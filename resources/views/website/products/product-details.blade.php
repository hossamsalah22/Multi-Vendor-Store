                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="{{ $product->image }}" id="current" alt="{{ $product->name }}">
                                </div>
                                <div class="images">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <p class="category"><i
                                    class="lni lni-tag"></i> {{ $product->category->parent->name == "Main Category" ? $product->category->name : $product->category->parent->name }}
                                @if($product->category->parent->name != "Main Category")
                                    :<a
